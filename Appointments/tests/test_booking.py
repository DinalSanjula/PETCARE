...
async def test_create_booking(async_client, clinic_token, owner_token):
    ...
    s_resp = await async_client.post("/appointments/slots", json=slot_payload, headers=clinic_headers)
    ...
    response = await async_client.post("/appointments/bookings", json=booking_payload, headers=owner_headers)
...
async def test_cancel_booking(async_client, clinic_token, owner_token):
    ...
    # Cancel
    response = await async_client.post(f"/appointments/bookings/{booking_id}/cancel", headers=owner_headers)
